...
public class InputOutput extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Outpunya disini");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int selectedItem = Integer.parseInt(jComboBox1.getSelectedItem().toString());
        int hasil = selectedItem + 7;
        jLabel1.setText(String.valueOf(hasil));
        model.addRow(new Object[]{selectedItem, hasil});
