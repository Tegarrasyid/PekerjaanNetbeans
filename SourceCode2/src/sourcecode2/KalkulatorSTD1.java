 ...
 * @author TEGAR RASYID
 */
public class KalkulatorSTD1 extends javax.swing.JFrame {

    /**
     * Creates new form KalkulatorSTD1
     */
    
     double num, ans;
    int calculation;
    
    public KalkulatorSTD1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KalkulatorSTD1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KalkulatorSTD1().setVisible(true);
            }
        });
    }
